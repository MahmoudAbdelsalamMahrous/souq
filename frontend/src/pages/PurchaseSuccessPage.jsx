			...
			<div className='max-w-md w-full bg-white rounded-lg shadow-xl overflow-hidden relative z-10'>
				<div className='p-6 sm:p-8'>
					...
					<div className='space-y-4'>
						<button
							className='w-full bg-black hover:bg-stone-800 text-white font-bold py-2 px-4
             rounded-lg transition duration-300 flex items-center justify-center'
						...
						<Link
							to={"/"}
							className='w-full bg-stone-100 hover:bg-stone-200 text-black font-bold py-2 px-4 
            rounded-lg transition duration-300 flex items-center justify-center'
						>
							Continue Shopping
